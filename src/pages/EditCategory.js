                        ...
                        <div className="col-12 mt-3">
                            <div className="row">
                                        ...
                                        <Formik>       
                                            <form className="row">
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <input type="text" className="form-control login-comn-input"  name="category" placeholder="Starters"/>
                                                </div>
                                                <div className="col-12 mb-3">
                                ...
                                <div className="bx-white-main comn-table-box new-brd-class">
                                    <MUIDataTable data={Edit_Category} columns={columns} options={options} />
                                </div>
                                </div>
                            </div>
                        </div>
